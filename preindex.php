...
<body>
  ...
  <header id="header" class="fixed-top" style="top: 0;">
    <div class="container d-flex align-items-center">
        ...
        <h1 class="logo me-auto"><a href="index.php">MAYdoc</a></h1>
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="index.php#hero">A propos</a></li>
          <li><a class="nav-link scrollto" href="index.php#services">Services</a></li>
          <li><a class="nav-link scrollto" href="index.php#departments">Departements</a></li>
          <li><a class="nav-link scrollto" href="index.php#appointment">Rendez-vous</a></li>
      ...
      <a href="login.php" class="appointment-btn scrollto"><span class="d-none d-md-inline">Se</span> connecter</a>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container">
      ...
      <a href="login.php" class="btn-get-started scrollto">Prendre rendez-vous</a>
    </div>
  </section><!-- End Hero -->
          ...
          <div class="col-lg-4 d-flex align-items-stretch">
            <div class="content">
              ...
              <div class="text-center">
                <a href="login.php" class="more-btn">Se connecter<i class="bx bx-chevron-right"></i></a>
              </div>
            </div>
          </div>
    ...
    <section id="appointment" class="appointment section-bg">
      <div class="container">
        ...
        <div class="section-title">
          ...
          <p>Vous devez vous connecter ou s'inscrire pour prendre un rendez-vous!</p>
        </div>

        <form action="#" method="" class="php-email-form">
          <div class="text-center"><a href="login.php" class="appointment-btn scrollto"><span class="d-none d-md-inline">Se</span> connecter</a></div>
        </form>
        ...
        <div class="row">
          ...
          <div class="col-lg-2 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="#hero">A propos</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#services">Services</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#specialite">Specialite</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#appointment">Rendez-vous</a></li>
            </ul>
          </div>
