...
<body>
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="PatientAcceuil.php#departments">Departements</a></li>
          <li><a class="nav-link scrollto" href="PatientAcceuil.php#doctors">Medecins</a></li>
        ...
        <div class="row">
          ...
          <div class="col-lg-2 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="PatientAcceuil.php#about">A propos</a></li>
          ...
          <div class="col-lg-4 col-md-6 footer-newsletter">
            ...
            <form action="" method="post">
              <input type="email" name="email"><input type="submit" value="Rejoindre">
            </form>
          </div>
  ...
  <script src="../../asset/js/main.js"></script>
   ...
   <script src="../../vendor/jquery/jquery.min.js"></script>
    ...
    <script src="../../script/appointement.js"></script>
